...
export const COPY = {
  sv: {
    ...
    middleC: 'mitt-C',
    quizScope: 'Quizet frågar bara efter de vita tonerna C4–C5.',
    ...
    blackKeyAttempt: (label: string) => <>Du tryckte på den svarta tangenten <strong>{label}</strong>. Quizet frågar bara efter de vita tonerna — läs noten och prova en vit tangent.</>,
    another: 'Försök igen',
  ...
  en: {
    ...
    middleC: 'middle C',
    quizScope: 'The quiz only asks for the white notes C4–C5.',
    ...
    blackKeyAttempt: (label: string) => <>You played the black key <strong>{label}</strong>. The quiz only asks for the white notes — read the note and try a white key.</>,
    another: 'Try again',
